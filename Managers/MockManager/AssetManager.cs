...
namespace MockManager
{
    ...
    public class AssetManager// : IManager
    {
        ...
        public void Init()
        {
            ...
            Logger.LogDebugOnly("AssetManager initialized.");
        }
        ...
        public AssetID AddAsset(Object asset, Object original)
        {
            ...
            AssetRef assetRef = new AssetRef(Main.Mod.GUID, asset, original);
        ...
        private static void AddAssetToBundleLoader(AssetBundleLoader assetBundleLoader, AssetID assetID, AssetRef assetRef)
        {
            ...
            string assetPath = $"{assetRef.sourceMod}/Prefabs/{assetRef.asset.name}";
        ...
        private struct AssetRef
        {
            ...
            public AssetRef(string sourceMod, Object asset, Object original)
            {
