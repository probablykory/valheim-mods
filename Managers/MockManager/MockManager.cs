...
namespace MockManager
{
    ...
    public class MockManager // : IManager
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool IsHeadless { get { return SystemInfo.graphicsDeviceType == GraphicsDeviceType.Null; } }
        ...
        public void Init()
        {
            ...
            MockPrefabContainer.transform.parent = Main.GetRootObject().transform;
        ...
        public static Object GetRealPrefabFromMock(Object unityObject, Type mockObjectType)
        {
            ...
            if (IsHeadless && mockObjectType == typeof(Texture))
            {
                return null;
            }
            ...
            var prefab = Cache.GetPrefab<GameObject>(assetName);
        ...
        {
            asset = Cache.GetPrefab(mockObjectType, assetName);
            return (bool)asset;
        }
